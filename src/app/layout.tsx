...
export const metadata: Metadata = {
  ...
  description: "A state-of-the-art premium coffee experience with curated roasts, subscriptions, and a guided discovery quiz.",
};

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" suppressHydrationWarning className={`${cardo.variable} h-full antialiased`}>
