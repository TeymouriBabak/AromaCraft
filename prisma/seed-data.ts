...
const productTemplates: Record<string, ProductTemplate[]> = {
  starbucks: [
    {
      ...
      brewMethods: ['Drip Coffee', 'Pour Over', 'Espresso'],
      ...
      sweetness: 'Medium',
      price: 12.99,
      subscriptionSavings: 1.3,
    },
    {
      name: 'Blonde Roast',
      origin: 'Light Roast Blend',
      country: 'USA Blend',
      roast: 'Light',
      coffeeType: 'Blend',
      brewMethods: ['Drip Coffee', 'Pour Over'],
      tastingNotes: ['Citrus', 'Vanilla', 'Caramel'],
      process: 'Blend',
      body: 'Light',
      acidity: 'Bright',
      sweetness: 'Medium',
    ...
    {
      name: 'Dark Roast',
      origin: 'Full City Roast',
      country: 'USA Blend',
      roast: 'Dark',
      coffeeType: 'Espresso Roast',
      brewMethods: ['Espresso', 'Moka Pot', 'French Press'],
      tastingNotes: ['Chocolate', 'Cocoa', 'Toffee'],
      process: 'Blend',
      body: 'Full',
      acidity: 'Low',
      sweetness: 'Low',
    ...
    },
    {
      ...
      tastingNotes: ['Berry', 'Citrus', 'Floral'],
      process: 'Washed',
      body: 'Medium',
      acidity: 'Bright',
      sweetness: 'Medium',
      price: 15.99,
      subscriptionSavings: 1.6,
    },
    {
      name: 'Espresso Roast',
      ...
      tastingNotes: ['Chocolate', 'Caramel', 'Toffee'],
      process: 'Blend',
      body: 'Full',
      acidity: 'Low',
      sweetness: 'Medium',
      price: 13.99,
      subscriptionSavings: 1.4,
    },
    {
      name: 'Decaf Pike Place',
      origin: 'Global Blend Decaf',
      country: 'USA Blend',
      roast: 'Medium',
      coffeeType: 'Decaf',
      brewMethods: ['Drip Coffee', 'Pour Over'],
      tastingNotes: ['Cocoa', 'Caramel', 'Brown Sugar'],
      process: 'Blend',
      body: 'Medium',
      acidity: 'Medium',
      sweetness: 'Medium',
  ...
  costa: [
    {
      name: 'Costa Signature Blend',
      origin: 'Signature Roast',
      country: 'UK Blend',
      roast: 'Medium',
      coffeeType: 'House Blend',
      brewMethods: ['Drip Coffee', 'Espresso', 'Pour Over'],
      tastingNotes: ['Chocolate', 'Cocoa', 'Caramel'],
      process: 'Blend',
      body: 'Full',
      acidity: 'Low',
      sweetness: 'Medium',
      price: 13.49,
      subscriptionSavings: 1.35,
    },
    {
      name: 'Costa Bright Blend',
      origin: 'Light Roast',
      country: 'UK Blend',
      roast: 'Light',
      coffeeType: 'Blend',
      brewMethods: ['Pour Over', 'Drip Coffee'],
      tastingNotes: ['Citrus', 'Floral', 'Vanilla'],
      process: 'Blend',
      body: 'Light',
      acidity: 'Bright',
      sweetness: 'Low',
    ...
    {
      name: 'Costa Coffee Del Mar',
      origin: 'South American Blend',
      country: 'UK/Colombia Blend',
      roast: 'Medium',
      coffeeType: 'Blend',
      brewMethods: ['Espresso', 'Moka Pot'],
      tastingNotes: ['Cocoa', 'Nutty', 'Caramel'],
      process: 'Blend',
      body: 'Medium',
      acidity: 'Medium',
      sweetness: 'Medium',
      price: 14.99,
      subscriptionSavings: 1.5,
    },
    {
      name: 'Costa Mocha Blend',
      origin: 'Ethiopian/Indonesian',
      country: 'UK/Multi Blend',
      roast: 'Dark',
      coffeeType: 'Blend',
      brewMethods: ['Espresso', 'French Press'],
      tastingNotes: ['Chocolate', 'Cocoa', 'Nutty'],
      process: 'Blend',
      body: 'Full',
      acidity: 'Low',
      sweetness: 'Medium',
  ...
  dunkin: [
    {
      ...
      origin: 'Classic American Roast',
      country: 'USA Blend',
      roast: 'Medium',
      coffeeType: 'House Blend',
      brewMethods: ['Drip Coffee', 'Espresso'],
      tastingNotes: ['Cocoa', 'Caramel', 'Brown Sugar'],
      process: 'Blend',
      body: 'Medium',
      acidity: 'Low',
      sweetness: 'Medium',
      price: 11.99,
      subscriptionSavings: 1.2,
    },
    {
      name: "Dunkin' Espresso Blend",
      origin: 'Strong Roast',
      country: 'USA Blend',
      roast: 'Dark',
      coffeeType: 'Espresso Roast',
      brewMethods: ['Espresso', 'Moka Pot'],
      tastingNotes: ['Chocolate', 'Toffee', 'Nutty'],
      process: 'Blend',
      body: 'Full',
      acidity: 'Low',
      sweetness: 'Low',
    ...
    {
      name: "Dunkin' Light Roast",
      origin: 'Bright & Smooth',
      country: 'USA Blend',
      roast: 'Light',
      coffeeType: 'Blend',
      brewMethods: ['Drip Coffee', 'Pour Over'],
      tastingNotes: ['Citrus', 'Vanilla', 'Brown Sugar'],
      process: 'Blend',
      body: 'Light',
      acidity: 'Medium',
      sweetness: 'Medium',
  ...
  mccafe: [
    {
      ...
      coffeeType: 'House Blend',
      brewMethods: ['Drip Coffee', 'Espresso'],
      tastingNotes: ['Caramel', 'Cocoa', 'Brown Sugar'],
      process: 'Blend',
      body: 'Medium',
      acidity: 'Low',
      sweetness: 'Medium',
      price: 10.99,
      subscriptionSavings: 1.1,
    },
    {
      name: 'McCafé Premium Roast Dark',
      origin: 'Bold Roast',
      country: 'USA Blend',
      roast: 'Dark',
      coffeeType: 'Espresso Roast',
  ...
  'tim-hortons': [
    {
      name: 'Tim Hortons Original Blend',
      origin: 'Canadian Classic',
      country: 'Canada Blend',
      roast: 'Medium',
      coffeeType: 'House Blend',
      brewMethods: ['Drip Coffee', 'Pour Over'],
      tastingNotes: ['Cocoa', 'Caramel', 'Vanilla'],
      process: 'Blend',
      body: 'Medium',
      acidity: 'Low',
      sweetness: 'Medium',
      price: 11.49,
      subscriptionSavings: 1.15,
    },
    {
      name: 'Tim Hortons Dark Roast',
      origin: 'Bold Canadian Roast',
      country: 'Canada Blend',
      roast: 'Dark',
      coffeeType: 'Blend',
      brewMethods: ['Drip Coffee', 'Espresso'],
      tastingNotes: ['Chocolate', 'Toffee', 'Brown Sugar'],
      process: 'Blend',
      body: 'Full',
      acidity: 'Low',
      sweetness: 'Low',
  ...
  'gloria-jeans': [
    {
      name: "Gloria Jean's Gourmet Espresso",
      origin: 'Italian Inspired',
      country: 'Australia/Italy Blend',
      roast: 'Dark',
      coffeeType: 'Espresso Roast',
      brewMethods: ['Espresso', 'Moka Pot'],
      tastingNotes: ['Chocolate', 'Cocoa', 'Caramel'],
    ...
    {
      name: "Gloria Jean's Columbian Gold",
      origin: 'Premium Colombian',
      country: 'Australia/Colombia Blend',
      roast: 'Medium',
      coffeeType: 'Single Origin',
      brewMethods: ['Pour Over', 'Drip Coffee'],
    ...
    {
      name: "Gloria Jean's Ethiopian Dreams",
      origin: 'East African',
      country: 'Australia/Ethiopia Blend',
      roast: 'Light',
      coffeeType: 'Single Origin',
      brewMethods: ['Pour Over', 'Espresso'],
  ...
  jacobs: [
    {
      name: 'Jacobs Kronung',
      origin: 'German Premium Blend',
      country: 'Germany Blend',
      roast: 'Medium',
      coffeeType: 'House Blend',
      brewMethods: ['Drip Coffee', 'Pour Over', 'Espresso'],
      tastingNotes: ['Cocoa', 'Caramel', 'Nutty'],
      process: 'Blend',
      body: 'Medium',
      acidity: 'Low',
      sweetness: 'Medium',
    ...
    {
      name: 'Jacobs Expertenröstung',
      origin: "Expert's Roast",
      country: 'Germany Blend',
      roast: 'Dark',
      coffeeType: 'Blend',
      brewMethods: ['Espresso', 'French Press'],
    ...
    {
      name: 'Jacobs Mild Roast',
      origin: 'Smooth German Blend',
      country: 'Germany Blend',
      roast: 'Light',
      coffeeType: 'Blend',
      brewMethods: ['Drip Coffee', 'Pour Over'],
...
const getSeed = (
  ...
  variantIndex: number
) => brandIndex * 100 + templateIndex * 10 + variantIndex;

const chooseDeterministic = <T>(options: T[], seed: number) =>
  options[seed % options.length];
const shouldIncludeTag = (seed: number, divisor: number) =>
  seed % divisor === 0;
...
Object.entries(productTemplates).forEach(
  ([brandKey, templates], brandIndex) => {
    templates.forEach((template, index) => {
      const variantCount = 2 + (index % 2);

      for (let v = 0; v < variantCount; v++) {
        const sizes: (typeof SIZES)[number][] = [
          '250g',
          '500g',
          '1kg',
          'Capsules',
        ...
        if (shouldIncludeTag(seed + 2, 2))
          specialTags.push('Subscription Eligible');
        ...
        const finalPrice = Math.max(
          8,
          Math.round((template.price * priceMultiplier + v * 1.5) * 100) / 100
        );
        ...
        products.push({
          ...
          originRegion:
            template.coffeeType === 'House Blend' ? 'Multi-Origin' : 'Africa',
          brewMethods: template.brewMethods as (typeof BREW_METHODS)[number][],
          roast: template.roast,
          tastingNotes:
            template.tastingNotes as (typeof FLAVOR_NOTES)[number][],
          ...
          description: `Premium ${template.coffeeType.toLowerCase()} with ${template.tastingNotes
            ...
            .join(
              ' and '
            )} notes. Ideal for ${template.brewMethods[0]?.toLowerCase() || 'coffee lovers'}.`,
